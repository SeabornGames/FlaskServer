...
if sys.version[0]=='2':
    from seaborn.sorters_2 import by_attribute, by_longest_then_by_abc, by_key, by_shortest_then_by_abc
else:
    from seaborn.sorters_3 import by_attribute, by_longest_then_by_abc, by_key, by_shortest_then_by_abc
