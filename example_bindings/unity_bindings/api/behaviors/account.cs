...
namespace demo.BenChristenson.behaviors
{
	...
	public class AccountArrayGet: ApiBehavior<AccountArrayGet>
	{
	    ...
	    public bool? primary = false;           // bool if True will only return accounts the user is primary
	...
	public class AccountPut: ApiBehavior<AccountPut>
	{
	    ...
	    public string name;                     // str of name for the account,
        defaults to the created timestamp
        public List<int> user_ids;              // list of int of users to give access to this account
