...
namespace demo.BenChristenson.operations
{
	...
	{
	    [HttpFormField] public int withdraw_account_id;         // int of the account_id to withdraw the money
	...
	public class AccountTransferDepositPut: HttpOperation
	{
        ...
        [HttpFormField] public float amount;                    // float of the amount to transfer
        [HttpFormField] public string receipt;                  // str of the validated receipt that money has
        been received
	...
	public class AccountTransferArrayGet: HttpOperation
	{
        ...
        [HttpQueryString] public bool? withdraws_only;            // bool if true only gets withdraw transfer
