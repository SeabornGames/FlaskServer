...
namespace demo.BenChristenson.operations
{
	...
	{
	    [HttpQueryString] public bool? primary = false;           // bool if True will only return accounts the user is primary
	...
	{
	    [HttpFormField] public string name;                     // str of name for the account,
        defaults to the created timestamp
        [HttpFormField] public List<int> user_ids;              // list of int of users to give access to this account
