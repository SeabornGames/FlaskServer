...
namespace demo.BenChristenson.placeholder
{
	public class BenChristensonCustomApi : MonoBehaviour
	{
        ...
        public static void AccountTransferWithdrawPut(
            int withdraw_account_id,                // int of the account_id to withdraw the money
        ...
        public static void AccountTransferDepositPut(
            ...
            float amount,                           // float of the amount to transfer
            string receipt)                         // str of the validated receipt that money has
        been received
        {   
        ...
        public static void AccountTransferArrayGet(
            ...
            bool? withdraws_only = null,            // bool if true only gets withdraw transfer
        ...
        public static void AccountAccessPut(
            int account_id,                         // int of the account_idor the account
        ...
        public static void AccountArrayGet(
            bool primary = false,                   // bool if True will only return accounts the user is primary
            int? offset = null,                     // int of the offset to use
            int? limit = null)                      // int of max number of puzzles to return
        {   
        ...
        public static void AccountPut(
            string name = null,                     // str of name for the account,
        defaults to the created timestamp
            List<int> user_ids = null)              // list of int of users to give access to this account
